...
/**
 * match (q:Club)<-[:PLAYS_IN]-(p:Player)-[:FROM]->(c:Country{nacionality: "POR"})
with q, count(p.Name) as portugueses_clube
return portugueses_clube
order by portugueses_clube asc
limit 1
 */